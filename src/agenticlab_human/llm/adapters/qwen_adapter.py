...
class QwenAdapter(BaseLLMClient):
    ...
    def call(
        ...
        **kwargs
        ...
        """
        Unified call method for Qwen LLMs
        Args:
    ...
    def _build_messages(
        ...
        if image is not None:
            ...
            for img in images:
                ...
                elif isinstance(img, str) and (img.startswith("http") or len(img) > 100):
                     content.append({
                        "type": "image_url", 
                        "image_url": {"url": img}
                    })
...
if __name__ == "__main__":
    ...
    # prompt = "Where is the robot gripper? And what is it holding?"
