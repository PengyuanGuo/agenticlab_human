...
```json
{
  ...
  "actions": [
    ...
    { "id": 2, "name": "place",  "args": { "object": "numbered-block-1", "target": "yellow-bin-1" } },
    { "id": 3, "name": "pick",             "args": { "object": "numbered-block-2", "from":   "gray-cloth-1" } },
    { "id": 4, "name": "place",  "args": { "object": "numbered-block-2", "target": "numbered-block-1" } }
  ]
}
```
...
class ActionBackend(Protocol):
    ...
    def place(self, object_name: str, target_name: str, target_pose=None, target_bbox=None, **kwargs) -> ActionResult: ...
...
class ActionExecutor:
    ...
    def execute(self, action) -> ActionResult:
        match action.name:
            ...
            case "place": return self._do_place(action.args)
